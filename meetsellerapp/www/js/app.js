    ...
    .factory('loadFileConfig', function ($http) {
        var mainInfo = $http.get('configApp.json').success(function(response) {
    ...
    .controller('MainCtrl', function ($scope, $ionicSideMenuDelegate, $translate , loadFileConfig) {
        ...
        $scope.configApp = loadFileConfig.getMainConfig();
         $scope.configApp1 = "1222"

    })
    .directive('myCustomer', function() {
  return {
    template: 'Name: aaa Address: aaa'
  };
})
